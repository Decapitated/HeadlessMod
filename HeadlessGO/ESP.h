...
namespace Hack {
	...
	private:
		...
		static void DrawHead(Vector headPos, Vector localHeadPos, ImU32 color);
		static void DrawSegment(IClientEntity* CurrentEnt, std::string bone_1, std::string bone_2, ImU32 color);
		static void DrawSegment(Vector a, Vector b, ImU32 color);
		static void DrawSkeleton(IClientEntity* CurrentEnt, ImU32 boneColor, ImU32 headColor);
		static void DrawSkeleton(Hack::Player* player, Vector localHeadPos, ImU32 boneColor, ImU32 headColor);
