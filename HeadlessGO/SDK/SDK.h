...
public:
    ...
    int GetTeam() { return *(int*)((uintptr_t)this + 0x98); }
};
...
public:
    ...
    {
        return (Vector*)((uintptr_t)this + 0x4E05F4);
    }
};
...
struct studiohdr_t
{
    ...
    inline void* pBonecontroller(int i) const { return  (((char*)this) + bonecontrollerindex) + i; };
...
public:
    ...
    virtual void		DrawSetColor(Colors::Color col) = 0;
    ...
    virtual void		DrawSetTextColor(Colors::Color col) = 0;
    ...
    void DrawSetTextColor2(Colors::Color col)
    {
        typedef void(__thiscall* fn)(void*, Colors::Color);
...
public:
    ...
    // sibling pins
    virtual void SetSiblingPin(unsigned int vguiPanel, unsigned int newSibling, char iMyCornerToPin = 0, char iSiblingCornerToPinTo = 0) = 0;
